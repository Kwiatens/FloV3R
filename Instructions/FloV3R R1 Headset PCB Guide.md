...
This is what we are going to build now:
...
Make sure to begin soldering SMD components than electrolitic capatitors, LED's and finally breakout boards such as Arduino, IMU etc.
